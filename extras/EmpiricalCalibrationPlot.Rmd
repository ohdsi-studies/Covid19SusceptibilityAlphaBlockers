...
plotEstimateVsError(controlResults, calibrated = TRUE)
ggplot2::ggsave("negative_control_calibrated_full_strat_estimates_and_std_errors_for_va.png")
...
plotEstimateVsError(controlResults, calibrated = TRUE)
ggplot2::ggsave("negative_control_calibrated_min_strat_estimates_and_std_errors_for_va.png")
plotEstimateVsError(controlResults, calibrated = FALSE)
