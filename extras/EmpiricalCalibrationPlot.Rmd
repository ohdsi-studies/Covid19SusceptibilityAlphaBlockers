...
primaryAnalysisId <- 6 # Full matched PS
```
...
```{r, echo=FALSE}
plotEstimateVsError <- function(controlResults, calibrated) {
...
plotEstimateVsError(controlResults, calibrated = TRUE)
ggplot2::ggsave("negative_control_calibrated_estimates_and_std_errors_for_va.png")
plotEstimateVsError(controlResults, calibrated = FALSE)
ggplot2::ggsave("negative_control_uncalibrated_estimates_and_std_errors_for_va.png")
```
