...
outputFolder <- "s:/Covid19SusceptibilityAlphaBlockersTest"
...
cmData <- CohortMethod::loadCohortMethodData(file.path(outputFolder, "cmOutput", omr$cohortMethodDataFile[1]))
cmData
summary(cmData)
