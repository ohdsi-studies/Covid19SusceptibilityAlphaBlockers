...
```{r}
largerDataIndex <- c(4, 2, 1) # OpenClaims, VA, SIDIAP
smallerDataIndex <- c(5, 6, 3) # Optum DOD, Optum EHR,  CUIMC
...
cowplot::save_plot(
  ...
  plot, base_asp = .8, base_height = 2 * length(databaseIds),
  units = "in", dpi = 300
)
```
