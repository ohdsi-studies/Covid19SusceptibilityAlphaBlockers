...
tcs <- lapply(
  ...
  title <- gsub("% Extra row",
               paste0("& \\\\multicolumn{3}{c}{$N$ = ", tcs[["SIDIAP"]]$targetSubjects, 
                      " } & \\\\multicolumn{3}{c}{$N$ = ", tcs[["SIDIAP"]]$comparatorSubjects, " } ",
                      "& \\\\multicolumn{3}{c}{$N$ = ",     tcs[["VA-OMOP"]]$targetSubjects, 
                      " } & \\\\multicolumn{3}{c}{$N$ = ",     tcs[["VA-OMOP"]]$comparatorSubjects, " } ",
                      "& \\\\multicolumn{3}{c}{$N$ = ", tcs[["CUIMC"]]$targetSubjects, 
                      " } & \\\\multicolumn{3}{c}{$N$ = ", tcs[["CUIMC"]]$comparatorSubjects, " } ",
                      " \\\\\\\\"),
               # , "\\\\\\\\ \n",
